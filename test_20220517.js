...
// 화살표 함수를 사용하지 않을 때에는 리턴값을 써 줘야 함 - 콜백함수이기 때문에 

console.log(result);

// filter를 사용하기 위해서는 배열이여야함
...
const countTextLenth = dummyText.reduce(function(before, current) {
  return before + current ;
});

console.log(countTextLenth.length);
